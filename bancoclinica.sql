CREATE DATABASE  IF NOT EXISTS `clinica2020` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `clinica2020`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: clinica2018
-- ------------------------------------------------------
...
-- Dump completed on 2020-07-25 12:04:20
